...
class CNNAttentionModel(nn.Module):
    def __init__(self, input_dim=6, hidden_dim=6, num_heads=3, num_layers=4, dropout=0.05):
...
# 训练模型的函数
def train_model(model, train_loader, val_loader, device, epochs=80, lr=0.05):
